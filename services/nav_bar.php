...
<nav id="navmenu" class="navmenu">
    <ul>
        ...
        <li><a href="../index.php#resume"><i
                    class="bi bi-file-earmark-text navicon"></i><span>Resume</span></a></li>
        <li><a href="../index.php#portfolio"><i class="bi bi-images navicon"></i><span>Portfolio</span></a>
        </li>
        <li><a href="../index.php#services"><i class="bi bi-hdd-stack navicon"></i><span>Services</span></a>
        </li>
